#ifndef NUMAPERF_ABSTRACTSHADOWMAP_H
#define NUMAPERF_ABSTRACTSHADOWMAP_H
...
protected:
    virtual inline unsigned long hashKey(unsigned long key) = 0;
...
#endif //NUMAPERF_ABSTRACTSHADOWMAP_H
