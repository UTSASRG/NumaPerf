...
// Treat int as an normal word, 4bytes
...
#define MAX_TOP_CALL_SITE_INFO 30
#define MAX_CALL_STACK_NUM 5
#define MAX_BACK_TRACE_NUM (2 + MAX_CALL_STACK_NUM)
...
#define PAGE_SERIOUS_SCORE_THRESHOLD (0.00075 * CYCLES_PER_MS)  //1500
#define TRUE_SHARING_SERIOUS_SCORE_THRESHOLD (0.0005 * CYCLES_PER_MS / 1000)  //20000
#define FALSE_SHARING_SERIOUS_SCORE_THRESHOLD (0.0005 * CYCLES_PER_MS / 1000) //1000 / 1000
...
#define TRUE_SHARING_DOMINATE_PERCENT 0.4
#define FALSE_SHARING_DOMINATE_PERCENT 0.4
#define TRUE_AND_FALSE_SHARING_DOMINATE_PERCENT 0.4
